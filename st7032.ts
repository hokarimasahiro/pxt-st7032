...
namespace st7032 {
    ...
    //% blockId="putCommand" block="put command %data"
    ...
    //% blockId="putData" block="put data % data"
    ...
    //% blockId="setAddress" block="set address % ad"
    ...
    //% blockId="setPosition" block="set position %x %y"
    export function setPosition(x:number,y:number): void {
        if((x > 3) || (y > 20)) return;

        putCommand( 0x80 + topAddress[x] + y);
    }
    //% blockId="writeData" block="write data %dt"
